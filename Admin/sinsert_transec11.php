...
$discount_amount = $_POST['discount_am'];
...
$insert_transaction_sql = "INSERT INTO transcation_info (
 	S_REG_NUM ,Description,class_nm1,Section,st_session,for_month,Monthly_fee,
   	Date, trans_amt
) VALUES (
    '$reg_num',
    '$des',
...
if (mysqli_query($conn, $insert_transaction_sql)) {
   $insert_second_table_sql = "UPDATE students SET Tuit_mode = '$mode', Total_fee = '$total_amount', Sibling_dis = '$discount_am', 
